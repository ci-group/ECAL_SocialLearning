	...
	class Worker extends Thread {
		...
		public void run() {
			try {
				...
				int value = rand.nextInt(123456); 
				long seed = value; //controller.getArguments("--population").getArgumentAsInt("run_seed");
				...
				String runEvolution = outputFolder + "/" + controller.getName() + ".conf --output " + outputFolder + "/"
